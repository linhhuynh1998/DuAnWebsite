...
@section('title')
    Thêm sản phẩm quản lý bán hàng
@stop
        ...
        <form action="{{ route('product.store') }}" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-8 float-left">
                <fieldset class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Thêm tên sản phẩm" name="name" value="{{ old('name') }}">
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" class="form-control" placeholder="Nội dung nổi bật sản phẩm" rows="5">{{ old('content') }}</textarea>
                ...
                <button type="submit" class="btn btn-success save" >Thêm sản phẩm</button>
            ...
            <div class="col-md-4 float-right">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" placeholder="Nhập số lượng" class="form-control" name="quantity" value="{{ old('quantity') }}">
                ...
                <div class="form-group">
                    <label for="">Giá</label>
                    <input type="number" min="1" placeholder="Nhập giá" class="form-control" name="price" value="{{ old('price') }}">
                    @if($errors->has('price'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" placeholder="Nhập giá khuyễn mãi" class="form-control" name="promotion" value="{{ old('promotion') }}">
                </div>
                <div class="form-group">
